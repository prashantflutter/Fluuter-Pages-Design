...
class EditEnquiresScreen extends StatefulWidget {
  final String user_id;
  final String contactPerson;
  final String otherState;
  final String companyEmail;
  final String companyEmail2;
  final String companyEmail3;
  final String phoneNumberController;
  final String phoneNumberController2;
  final String phoneNumberController3;
  ...
  final String assignUserValue;
  final String sourceValue;
  const EditEnquiresScreen({super.key,
    required this.user_id, required this.contactPerson, required this.otherState,
    required this.companyEmail, required this.companyEmail2, required this.companyEmail3,
    required this.phoneNumberController, required this.phoneNumberController2,
    required this.phoneNumberController3, required this.stateController,
    required this.cityController, required this.addressController,
    required this.machineDescription, required this.searchController,
    required this.products_id, required this.importanceValue,
    required this.stateValue, required this.assignUserValue, required this.sourceValue});

  @override
  State<EditEnquiresScreen> createState() => _EditEnquiresScreenState();
}

class _EditEnquiresScreenState extends State<EditEnquiresScreen> {
  ...
  void checkDetailsFill(){
    ...
    if(companyName.text.isEmpty && phoneNumberController.text.isEmpty && companyEmail.text.isEmpty && contactPerson.text.isEmpty && _imageList.isEmpty){
      ...
      addEnquiryController.AddEnquirySource(
        ...
        // visit_card: _imageList.isNotEmpty?,
        extension: ".jpg"
